<template>
	<v-app class="container">
		<v-container>
			<TheVCol>
				<v-img
					src="@/assets/images/logo-kolab-aja.png"
					alt="Kolab Aja Logo"
					contain
					max-width="10rem"
				></v-img>
					...
					<TheVRow>
							...
							<form @submit.prevent="handleSubmitForm">
								<div class="taskInput ml-11 mt-5">
									<TheVRow>
										<TheInput
											max-width="800"
											custom-label="Task"
											placeholder="Persiapkan Roles Team"
											bg-color="white"
											v-model="task"
									...
									<TheVRow class="d-flex ga-5">
										<TheVCol>
											<TheInput
												...
												max-width="700"
												custom-label="Presentase"
												placeholder="20"
												bg-color="white"
												v-model="persentase"
												:error-messages="errorPersentase"
											/>
										</TheVCol>
										<TheVCol class="d-flex flex-column pa-0" style="height: min-content">
											...
											<v-date-input
												...
												:error-messages="errorSelectedDate"
											/>
										</TheVCol>
									</TheVRow>
								</div>
								<div class="mt-10">
									<TheButton
										size="l"
										type="primary"
										style="width: 126px; font-weight: 700"
						...
						<TheVCol md="3">
							...
							<div class="mt-7">
								...
								<h6 style="font-weight: 400">{{ mileStoneData?.proyek_anggaran.slice(0, -3) + 'k' }}</h6>
							</div>
							<div class="mt-7">
							...
							<div>
								<v-progress-linear
									:model-value="mileStoneData?.milestone_persentase"
									color="var(--secondary--purple, #46377D)"
									height="25"
									class="mt-5"
									rounded="round"
								>
...
const handleSubmitForm = async () => {
	if ( !errorTask.value && !errorDeskripsi.value && !errorTautan.value && !errorPersentase.value && !errorSelectedDate.value ) {
		try {
