<template>
	<v-app>
		<TheSidebar active-at="/client/progress" navbarTitle="Pengaturan Project">
...
import ProjectSetup from '@/utils/client/progress-page/project-setup.vue';
import OnGoing from "@/utils/client/on-going/on-going.vue";
