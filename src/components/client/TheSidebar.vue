<template>
	<v-app-bar order="1" elevation="0" height="90" class="app-bar">
		...
		<div class="d-flex align-center ga-3">
			<TheButton size="s" @click="handleTambahProject">Tambah Project</TheButton>
...
const Menu = {
	Account: [
		{ title: "Profil", route: "/client/profile", icon: "mdi-account" },
	],
	Navigation: [
		{
			title: "Progress",
		...
		{ title: "Pembayaran", route: "/client/payment", icon: "mdi-cash" },
	],
};
...
const handleTambahProject = () => {
	router.push("/client/add-project")
}
