	...
	<v-navigation-drawer class="custom-drawer" v-model="drawer" :width="300">
		<v-list class="sidebar-container">
			<v-list class="menu-items">
				...
				<v-btn
					variant="plain"
					class="pa-0 mt-7 d-flex ga-5"
					color="primaryTosca"
					@click="findProject"
				>
					<v-icon icon="mdi-magnify" class="mr-2" size="30"></v-icon>
					<div class="text-h6">Find Project</div>
				</v-btn>
...
const Menu = {
	Account: [
		{
			title: "Akun",
			route: "/creative-hub-team/account",
			icon: "mdi-account-key",
		},
		{
			title: "Profil Tim",
			route: "/creative-hub-team/profile",
	...
	Navigation: [
		{
			title: "Progress",
			route: "/creative-hub-team/progress",
			icon: "mdi-chart-line",
		},
		{
			title: "Pembayaran",
			route: "/creative-hub-team/payment",
			icon: "mdi-cash",
		},
	],
};
...
const findProject = () => {
    router.push('/creative-hub-team/find-project');
};
