...
const Menu = {
	Account: [
		{ title: "Profil", route: "/controller/profile", icon: "mdi-account" },
	],
	Navigation: [
		{
			title: "Progress",
			route: "/controller/progress",
			icon: "mdi-chart-line",
		},
		{
			title: "Milestone",
			route: "/controller/milestone",
			icon: "mdi-timeline",
		},
		{ title: "Pembayaran", route: "/controller/payment", icon: "mdi-cash" },
	],
};
